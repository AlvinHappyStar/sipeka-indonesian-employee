  ...
  try {
    ...
    const total_gaji_pegawai = gaji_pegawai.map((pegawai) => {
      ...
      const kehadiran = resultDataKehadiran.find(
        (k) => k.nama_pegawai === pegawai.nama_pegawai        
      );
      ...
      return {
        tahun: potongan ? potongan.tahun : kehadiran ? kehadiran.tahun : '',
        bulan: potongan ? potongan.bulan : kehadiran ? kehadiran.bulan : '',
        id: id,
        nik: pegawai.nik,
        nama_pegawai: pegawai.nama_pegawai,
        ...
        sakit: kehadiran? kehadiran.sakit : 0,
        alpha: kehadiran? kehadiran.alpha : 0,
        potongan: potongan ? potongan.total_potongan.toLocaleString() : 0,
        total: total_gaji,
      };
    });
    console.log("=====total_gaji_pegawai", total_gaji_pegawai);
